...
namespace Hotel.UI.Controllers
{
	...
	[ApiController]
	public class GallaryCatagoryController : ControllerBase
	{
		private readonly IGallaryCatagoryService _catagoryService;
		public GallaryCatagoryController(IGallaryCatagoryService catagoryService)
		{
		...
		[HttpPost]
		public async Task<IActionResult> Post([FromForm] CreateCatagoryDto createCatagory)
		{
			try
			{
		...
		[HttpPut("{id}")]
		public async Task<IActionResult> Put(int id, [FromForm] UpdateCatagoryDto updateCatagory)
		{
			try
			{
